...
import { getPresenciaDigitalWhatsAppUrl } from '@/lib/presencia-digital';
...
const PresenciaDigitalNavbar = memo(function PresenciaDigitalNavbar() {
  const [mobileMenuOpen, setMobileMenuOpen] = useState(false);
  const [scrolled, setScrolled] = useState(false);
  const [activeSection, setActiveSection] = useState<string>('');
  const t = useTranslations('presenciaDigital.navbar');
...
export default PresenciaDigitalNavbar;
